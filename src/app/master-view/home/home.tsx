        ...
        <div className={classes("row-layout group")}>
          <div className={classes("column-layout group_1")}>
            <div className={classes("column-layout group_2")}>
              ...
              <a href="" onClick={() => navigate(`/master-view/reports`)} className={classes("typography__body-2 hyperlink")}>
            ...
            <div className={classes("column-layout group_4")}>
              ...
              <a href="" onClick={() => navigate(`/master-view/contracts`)} className={classes("typography__body-2 hyperlink")}>
          ...
          <div className={classes("column-layout group_5")}>
            <div className={classes("column-layout group_6")}>
                    ...
                    <IgrListItem key={uuid()}>
                      ...
                      <div key={uuid()}>
                        <div className={classes("column-layout group_8")} key={uuid()}>
                          <a href="" onClick={() => navigate(`/master-view/account-sample`)} className={classes("typography__body-2 hyperlink_1")}>
              ...
              <a href="" onClick={() => navigate(`/master-view/accounts`)} className={classes("typography__body-2 hyperlink")}>
            ...
            <div className={classes("column-layout group_6")}>
              ...
              <a href="" onClick={() => navigate(`/master-view/contacts`)} className={classes("typography__body-2 hyperlink")}>
          ...
          <div className={classes("column-layout group_5")}>
            <div className={classes("column-layout group_4")}>
              ...
              <a href="" onClick={() => navigate(`/master-view/calendar`)} className={classes("typography__body-2 hyperlink")}>
            ...
            <div className={classes("column-layout group_4")}>
              ...
              <a href="" onClick={() => navigate(`/master-view/tasks`)} className={classes("typography__body-2 hyperlink")}>
