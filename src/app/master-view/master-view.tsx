        ...
        <div className={classes("row-layout group_3")}>
          <IgrNavDrawer open="true" position="relative" ref={navDrawer} className={classes("nav-drawer")}>
            <IgrList className={classes("list")} key={uuid()}>
              <div style={{display: 'contents'}} onClick={() => navigate(`/master-view/home`)} key={uuid()}>
                <IgrListItem>
              ...
              <div style={{display: 'contents'}} onClick={() => navigate(`/master-view/accounts`)} key={uuid()}>
                <IgrListItem>
                  <div slot="start" key={uuid()}>
              ...
              <div style={{display: 'contents'}} onClick={() => navigate(`/master-view/contacts`)} key={uuid()}>
                <IgrListItem>
                  <div slot="start" key={uuid()}>
              ...
              <div style={{display: 'contents'}} onClick={() => navigate(`/master-view/contracts`)} key={uuid()}>
                <IgrListItem>
                  <div slot="start" key={uuid()}>
              ...
              <div style={{display: 'contents'}} onClick={() => navigate(`/master-view/reports`)} key={uuid()}>
                <IgrListItem>
                  <div slot="start" key={uuid()}>
              ...
              <div style={{display: 'contents'}} onClick={() => navigate(`/master-view/calendar`)} key={uuid()}>
                <IgrListItem>
                  <div slot="start" key={uuid()}>
              ...
              <div style={{display: 'contents'}} onClick={() => navigate(`/master-view/tasks`)} key={uuid()}>
                <IgrListItem>
                  <div slot="start" key={uuid()}>
